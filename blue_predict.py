...
class blue_predict(threading.Thread):
	def __init__(self):
		threading.Thread.__init__(self)
		self.__sess = tf.Session()
		self.__saver = tf.train.import_meta_graph("./save/blue_ocr/model.meta")
		self.__saver.restore(self.__sess, tf.train.latest_checkpoint("./save/blue_ocr"))
